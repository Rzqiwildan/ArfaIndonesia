...
<body class="bg-gray-50 min-h-screen py-8">
    ...
    <script>
        ...
        // Show car information when car is selected
        ...
        document.getElementById('rentalForm').addEventListener('submit', function(e) {
            const rentalDate = new Date(document.getElementById('tanggalPenyewaan').value);
            const returnDate = new Date(document.getElementById('tanggalPengembalian').value);
            
            if (returnDate <= rentalDate) {
                e.preventDefault();
                alert('Tanggal pengembalian harus setelah tanggal penyewaan!');
                return false;
            }
        });
    </script>
